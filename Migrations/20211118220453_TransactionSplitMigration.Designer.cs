...
namespace pfm.Migrations
{
    ...
    [Migration("20211118220453_TransactionSplitMigration")]
    partial class TransactionSplitMigration
    {
            ...
            modelBuilder.Entity("pfm.Database.Entities.TransactionSplitEntity", b =>
                {
                    ...
                    b.HasOne("pfm.Database.Entities.TransactionEntity", "ParentTransaction")
                        .WithMany("Splits")
